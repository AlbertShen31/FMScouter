                                                        ...
                                                        html.Div(
                                                            [
                                                                _field_label(
                                                                    "Columns",
                                                                    tip=(
                                                                        "Hide standalone IP and OOP role columns from "
                                                                        "the table. Hybrid combo scores stay visible. "
                                                                        "Does not change min-score filtering."
                                                                    ),
                                                                    help_id="rs-help-filter-columns",
                                                                ),
                                                                dmc.Switch(
                                                                    id="rs-hybrids-only",
...
def _score_column_styles(role_labels: list[str]) -> list[dict]:
    """Center score cells; wide enough for ``XXX+`` hybrid first-line headers."""
    rules = []
