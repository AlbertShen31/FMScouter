...
INTENTIONALLY_UNUSED: dict[str, str] = {
    ...
    "Shts Blckd": "Shots blocked total; Shts Blckd/90 scored (ui_hidden; Box Defender)",
    "Shts Blckd/90": "Stats percentile (ui_hidden; Box Defender archetype)",
    "Chances Created per 90": "Percentile (ui_hidden; Creative Wingback archetype)",
    ...
    "Dist/90": "Percentile (ui_hidden; Box-to-Box Midfielder archetype)",
    "Distance": "Distance total; Dist/90 scored (ui_hidden; Box-to-Box)",
    ...
    "Mistakes Leading to Goals": "GK percentile (ui_hidden; Shot Stopper archetype)",
    "NP-xG": "Non-penalty xG total; NP-xG/90 scored (ui_hidden; Attacking Wingback)",
    "NP-xG/90": "Percentile (ui_hidden; Attacking Wingback archetype)",
    ...
    "Open Play Key Passes per 90": "Percentile (ui_hidden; Creative Wingback archetype)",
    "Passes Completed": "Pass total; passes attempted /90 scored",
    "Passes Completed per 90": "Not in stats benchmarks",
    "Penalties Faced": "GK percentile (ui_hidden; Penalty Killer archetype)",
    "Penalties Saved": "GK percentile (ui_hidden; Penalty Killer archetype)",
    "Penalties Saved Ratio": "GK percentile (ui_hidden; Penalty Killer archetype)",
    ...
    "Save Percentage": "GK percentile (ui_hidden; Shot Stopper archetype)",
    ...
    "Tackles Completed per 90": "Stats percentile «Tackles Completed» (tackles_completed)",
